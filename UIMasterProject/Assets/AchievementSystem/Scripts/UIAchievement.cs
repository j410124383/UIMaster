...
public class UIAchievement : MonoBehaviour
{
    ...
    /// </summary>
    public void Set (AchievementInfromation Information)
    {
        ...
        if (Information.Spoiler && !Information.State.Achieved)
        {
            ...
            SpoilerText.text = UIM_AchievenManager.instance.SpoilerAchievementMessage;
        }
        else
        {
            print(Title.name);
            ...
            {
                float CurrentProgress = UIM_AchievenManager.instance.ShowExactProgress ? State.Progress : (State.LastProgressUpdate * Information.NotificationFrequency);
